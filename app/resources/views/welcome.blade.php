...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/home') }}"
                class="text-sm text-gray-500 underline">Home</a>
            @else
            <a href="{{ route('login') }}"
                class="text-sm text-gray-500 underline">Login</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}"
                class="ml-4 text-sm text-gray-500 underline">Register</a>
            @endif
            @endif
            <a href="{{ url('/terms') }}"
                class="text-sm text-gray-500 underline ml-4">Terms</a>
        </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="user">
                <a href="/login"
                    class="btn btn-outline-light btn-lg px-5">Login</a>
                <a href="/signup"
                    class="btn btn-outline-light btn-lg px-5">Signup</a>
            </div>


            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <a href="https://github.com/jeremykenedy/laravel-auth"
                    target="_blank">
